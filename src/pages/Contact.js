                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-5">
                            <div className="intro-excerpt">
                                ...
                                <p><Link to="/shop" className="btn btn-secondary me-2">Shop Now</Link><Link to="explore" className="btn btn-white-outline">Explore</Link></p>
                            </div>
                        </div>
                                ...
                                <div className="row mb-5">
                                    ...
                                    <div className="col-lg-4">
                                        <div className="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                                            ...
                                            <div className="service-contents">
                                                <p>thoeurn.ratha.kh@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
